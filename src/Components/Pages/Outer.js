      ...
      <Card className='card' style={{ width: "600px", padding: "30px", boxShadow: '0 10px 15px rgba(0, 0, 0, 0.2)' }}>
        ...
        <CardContent style={{marginTop:"30px" }}>
          <Grid container spacing={2}>
            ...
            <Grid xs={6}>
              <CardContent style={{marginTop:"30px" }}>
                <Typography style={{padding:"10px" }} variant="h6">{user.Name}</Typography>
                <Typography style={{padding:"10px" }} variant="h6">{user.Email}</Typography>
                <Typography style={{padding:"10px" }} variant="h6">{user.Password}</Typography>
                <Typography style={{padding:"10px" }} variant="h6">{user.JoiningDate}</Typography>
